...
async def on_message(message):
    ...
    if message.content.startswith('!balance 0conf'): #0conf balance
        ...
        msg = '{0.author.mention}, you have %f ASPIRE, including 0-confirmations.'.format(message)%balance
        return await client.send_message(message.channel,msg)
    ...
    if message.content.startswith('!balance'):
        ...
        msg = '{0.author.mention}, you have %f ASPIRE'.format(message)%(balance)
        return await client.send_message(message.channel,msg)
    ...
    if message.content.startswith('!tip '):
        ...
        try:
            ...
            return await client.send_message(message.channel,"{0.author.mention} has tipped %s %f ASPIRE.".format(message)%(toTipMention,amount))
        except ValueError:
    ...
    if message.content.startswith('!donate'):
        account = message.author.id
        address = "AZYLHy8EstWNbTy8oUosrLSbWLE5pL3zDZ"#ASPIRE donation fund
        amount = message.content.split()[1]
...
client.run('NTMwMTUzNDU1NTEyMzIyMDY4.Dw7PlA.cvLCGa0VKQq9siuiDQ-6Pe7dbAo')
